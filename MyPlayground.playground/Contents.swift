...
////  //more succinct but...scheduler protocol has more capabilities: work on a timer
////}
//
...
scheduler.advance(by: 1000) //controlling flow of time, else would have to wait 1000 seconds.
